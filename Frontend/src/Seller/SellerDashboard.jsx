...
export default function SellerDashboard() {
  ...
  const handleAddCrop = async (cropData) => {
    try {
      ...
      const response = await fetch("https://krushimitra-business.vercel.app/api/seller/dashboard/crop", {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
  ...
  const handleEditCrop = async (cropId, cropData) => {
    try {
      const token = localStorage.getItem("sellerToken");
      const response = await fetch(`https://krushimitra-business.vercel.app/api/seller/dashboard/crop/${cropId}`, {
        method: 'PUT',
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
  ...
  const handleUpdateProfile = async (newName) => {
    try {
      const token = localStorage.getItem("sellerToken");
      const response = await fetch('https://krushimitra-business.vercel.app/api/seller/dashboard/profile', {
        method: 'PUT',
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
