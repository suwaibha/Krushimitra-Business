...
const SignUpPage = ({ onSwitch }) => {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-400 mb-6">Buyer account • Start in seconds</p>
      ...
      <p className="text-center text-sm text-gray-400 mt-5">
        Are you a seller?{" "}
        <button onClick={() => navigate('/auth')} className="font-semibold" style={{ color: "#2d6a4f" }}>
          Continue as Seller
        </button>
      </p>
    </div>
...
const SignInPage = ({ onSwitch }) => {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-400 mb-6">Sign in to your buyer account</p>
...
export default function BuyerAuthentication() {
